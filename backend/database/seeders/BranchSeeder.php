...
class BranchSeeder extends Seeder
{
	...
	public function run(): void
	{
		Branch::insert([
			...
			['status'=>Branch::STATUS_ACTIVE,'label'=>'Mercado & Distribuidora Mello','name'=>'mello','document'=>null,'registration_state'=>null,'address_zip'=>null,'address_street'=>null,'address_city'=>null,'address_state'=>null,'phone'=>null,'email'=>null],
		]);
	}
}
